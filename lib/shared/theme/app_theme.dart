...
class AppTheme {
  ...
  static TextTheme get _textTheme {
    ...
    return bodyFont.copyWith(
      displayLarge: headingFont.displayLarge?.copyWith(fontWeight: FontWeight.bold),
      displayMedium: headingFont.displayMedium?.copyWith(fontWeight: FontWeight.bold),
      displaySmall: headingFont.displaySmall?.copyWith(fontWeight: FontWeight.bold),
      headlineLarge: headingFont.headlineLarge?.copyWith(fontWeight: FontWeight.bold),
      headlineMedium: headingFont.headlineMedium?.copyWith(fontWeight: FontWeight.bold),
      headlineSmall: headingFont.headlineSmall?.copyWith(fontWeight: FontWeight.bold),
      bodyLarge: bodyFont.bodyLarge?.copyWith(fontWeight: FontWeight.bold),
      bodyMedium: bodyFont.bodyMedium?.copyWith(fontWeight: FontWeight.bold),
      bodySmall: bodyFont.bodySmall?.copyWith(fontWeight: FontWeight.bold),
    );
  }
