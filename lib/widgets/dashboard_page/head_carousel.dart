...
class _HeadCarouselState extends State<HeadCarousel> {
  List<StaticImages> images = [
    StaticImages(
        imagePath: Assets.images.homeFirstBanner.path, link: 'https://flutter.dev'),
    StaticImages(
        imagePath: 'assets/images/advertise1.png', link: 'https://github.com'),
    StaticImages(
        imagePath: Assets.images.homeFirstBanner.path, link: 'https://youtube.com'),
  ];
            ...
            child: Swiper(
              itemBuilder: (
                ...
                return InkWell(
                  ...
                  child:
                      Image.asset(images[index].imagePath, fit: BoxFit.contain),
                );
              },
